# -*- coding: utf-8 -*-
#
# Isomer documentation build configuration file, created by
...
devel = release.split('dev')[1] if "dev" in version_module.version_info else False
...
todo_include_todos = devel is not False
